...
class Kwpborgs_Gallery_Admin_Pages
{
    ...
    public function enqueue_admin_css_js()
    {
        ...
        // Main Plugin Page
        if ($this->plugin_screen_hook_suffix['kwpborgs_gallery'] == $screen->id) {
            /* Admin Styles */
    ...
    public function add_plugin_admin_menu()
    {
         ...
         *
         */
        $this->plugin_screen_hook_suffix['kwpborgs_gallery'] = add_submenu_page(
            'edit.php?post_type=entries',
			__('CONF KWPBorgs Gallery', 'kwpborgs-gallery'),
            __('CONF KWPBorgs Gallery', 'kwpborgs-gallery'),
            'manage_options',
