 ...
 */
class Kwpborgs_Gallery_Shortcode_Admin
{
    ...
    {
        $ajax_nonce = wp_create_nonce('kwpborgs_gallery_shortcode_ajax_request');
        ?>
<!-- TinyMCE Shortcode Plugin -->
<script type='text/javascript'>
    var kwpborgs_gallery_tinymce = {
...
<?php
    ...
    {
        $plugin_array['kwpborgs_gallery_tinymce'] = plugins_url('tinymce/tinymce-plugin.js', __FILE__);
        return $plugin_array;
    }
    ...
    {
        array_push($buttons, 'kwpborgs_gallery_tinymce');
        return $buttons;
    }
    ...
    public function ajax_admin_shortcode_popup()
    {
        ...
        // Security check
        check_ajax_referer('kwpborgs_gallery_shortcode_ajax_request', 'nonce');
