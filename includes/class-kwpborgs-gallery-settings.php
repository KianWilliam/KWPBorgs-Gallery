 ...
 * Plugin Settings
 */
class Kwpborgs_Gallery_Settings
{
     ...
     * @var      array
     */
    public static $settings_group_id = 'kwpborgs-gallery-settings';
    ...
    public static $settings_tabs = array(
        'kwpborgs_gallery_first_tab'  => 'Galleries',
    ...
    private static $settings_sections = array(
        'section_one'   => array(
            'tab'         => 'kwpborgs_gallery_first_tab',
            'title'       => 'Gallery Details',
            'description' => 'All Settings For Your Gallery',
        ),
      /*  'section_two'   => array(
...
Mauris lectus augue, mollis eget ultricies quis, gravida vitae mauris.
    ...
    public function admin_options_init()
    {
        ...
        foreach (self::$settings_sections as $section_id => $section) {
            add_settings_section($section_id, __($section['title'], 'kwpborgs-gallery'), array($this, 'sections_callback'), $section['tab']);
        }
...
<p><?php _e(self::$settings_sections[$section_id]['description'], 'kwpborgs-gallery');?></p>
<?php   }
        }
    }
